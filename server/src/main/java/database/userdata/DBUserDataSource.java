        ...
        if (!this.userExists(UserIdentifier.USERNAME, username) && !this.userExists(UserIdentifier.EMAIL, email)) {
            ...
            try {
                ...
                try {
                    ...
                    log.error("Beim Freigeben des Statements zum Anlegen eines Users in die DB ist ein Fehler aufgetreten", se);
                }
        ...
        if (this.userExists(identifier, value)) {
            ...
            try {
                ...
                try {
                    ...
                    log.error("Beim Freigeben des Statements zum Löschen eines Users in die DB ist ein Fehler aufgetreten", se);
                }
                dbUserHelper.close();
            }
        } else {
        ...
        if (this.userExists(UserIdentifier.ID, id)) {
            ...
            try {
                ...
                try {
                    ...
                    log.error("Beim Freigeben des Statements zum Ändern der Daten eines Users in der DB ist ein Fehler aufgetreten", se);
                }
                dbUserHelper.close();
            }
        }
        ...
        if(userExists(identifier, value)) {
            ...
            try {
                ...
                try {
                    ...
                    log.error("Beim Freigeben des Statements zum Abfragen eines Users aus der DB ist ein Fehler aufgetreten", se);
                }
                dbUserHelper.close();
            }
        } else {
