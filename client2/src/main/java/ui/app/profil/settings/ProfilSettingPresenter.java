...
public class ProfilSettingPresenter extends Presenter<IProfilSettingView> {
  ...
  public ProfilSettingPresenter(IProfilSettingView view, EventBus eventBus, Connection connection, User user) {
    super(view, eventBus);
