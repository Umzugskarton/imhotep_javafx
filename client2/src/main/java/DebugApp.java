...
public class DebugApp {
  ...
  private void initLobbyList() {
    ...
    lobbyListButton1.setOnAction(new EventHandler<ActionEvent>() {
      ...
      public void handle(ActionEvent event) {
        ...
        colors.add("Red");
        CommonLobby lobby = new CommonLobby(1, "Lobby 1", lobbyUsers, false, 4, true, "Testuser",
            readyStaus, colors);
        lobbys.add(lobby);
    ...
    lobbyListButton3.setOnAction(new EventHandler<ActionEvent>() {
      ...
      public void handle(ActionEvent event) {
        ...
        CommonLobby lobby = new CommonLobby(0, "test", lobbyUsers, false, 2, true, "testuser",
            ready, colors);
    ...
    lobbyListButton4.setOnAction(new EventHandler<ActionEvent>() {
      ...
      public void handle(ActionEvent event) {
        ...
        CommonLobby lobby = new CommonLobby(1, "test", lobbyUsers, false, 2, true, "testuser",
            ready, colors);
        LobbyInfoEvent lobbyInfoEvent = new LobbyInfoEvent(lobby);
  ...
  public void gotDeadEvent(DeadEvent deadEvent) {
    ...
    Text text = new Text(
        date.toString() + " - Got dead event " + deadEvent.getEvent() + ", from " + eventBus);
